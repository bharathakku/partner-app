...
// Ensure base URL always points to the API namespace even if env omits '/api'
const RAW_API_BASE = process.env.NEXT_PUBLIC_API_BASE_URL || 'http://localhost:4001/api';
...
export const API_BASE_URL = ensureApiSuffix(RAW_API_BASE);
...
class HttpClient {
  constructor(baseURL = API_BASE_URL) {
    this.baseURL = ensureApiSuffix(baseURL);
    this.defaultHeaders = {
